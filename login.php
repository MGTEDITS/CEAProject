	...
	<form action="php/login.php" method="post" class="ftco-section">
		<div class="container">
			...
			<div class="row justify-content-center">
	            ...
	            <div class="form-group">
	              <input name="txtpasswordlog" id="password-field" type="password" class="form-control" placeholder="Palavra-Passe" required>
	              <span toggle="#password-field" class="fa fa-fw fa-eye field-icon toggle-password"></span>
	            </div>
	            <div class="form-group">
	            	<button type="submit" name="btniniciarsessao" class="form-control btn btn-primary submit px-3">Iniciar Sessão</button>
	            </div>
	            	...
	            	<div class="w-50">
		            	<label class="checkbox-wrap checkbox-primary">Lembrar-me
								...
								<div class="w-50 text-md-right">
									<a href="#" style="color: #fff">Esqueci-me da password</a>
								</div>
	            </div>
	          </form>
