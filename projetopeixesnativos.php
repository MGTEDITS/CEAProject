...
<html lang="en">
    <head>
        ...
        <title>Projeto Peixes Nativos</title>
                ...
                <div class="col-lg-8">
                    ...
                    <article>
                        ...
                        <header class="mb-4">
                            ...
                            <h1 class="fw-bolder mb-1">Projeto Peixes Nativos</h1>
                        ...
                        <figure  class="mb-4"><img style="width: 100%" class="img-fluid rounded" src    ="Images/Turtle-and-tropical-fish_466.jpg" alt="..." /></figure>
